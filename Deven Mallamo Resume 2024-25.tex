...
%%% Define Colors %%%
\definecolor{boxfill}{RGB}{255,255,255} %Border : #405762
...
% 	\item Hosted the website with an AWS Linux EC2 Instance with an Apache HTTP server.% \end{itemize}
...
\textbf{Tools} - Git/GitHub, Amazon Web Services, Linux, Various front-end and back-end frameworks %, Visual Studio Code, Visual Studios, Various IDEs
